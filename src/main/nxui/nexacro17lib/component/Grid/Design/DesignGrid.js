...
if (nexacro.Grid) {
	...
	_pGridCellControl._on_apply_status = function (oldstatus, status, olduserstatus, userstatus, apply, is_userstatus, status_param, value_param, applycssstatus, applycssuserstatus) {
		if (!this._isPreviewMode() || this.parent instanceof nexacro._GridRowControl) {
			return this._org_on_apply_status(oldstatus, status, olduserstatus, userstatus, apply, is_userstatus, status_param, value_param, applycssstatus, applycssuserstatus);
		}

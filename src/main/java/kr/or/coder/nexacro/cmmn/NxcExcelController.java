package kr.or.coder.nexacro.cmmn;
...
public class NxcExcelController {
	...
	public void exportGridToExcel (HttpServletRequest request, HttpServletResponse response) {
		...
		if(result < 0) {
			sendErrorMessage(response, result, messageSource.getMessage("error.nexacro.excel.import", new String[] {String.valueOf(result), resultMsg}), Locale.KOREA);
		}
	}
	...
	public void importGridToExcel (HttpServletRequest request, HttpServletResponse response) {
		...
		if(result < 0) {
			sendErrorMessage(response, result, commonMessageSource.getMessage("Error.E051", new String[] {String.valueOf(result), resultMsg}));
		}
	}

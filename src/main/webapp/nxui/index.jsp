...
<body style="margin:0;border:none;-ms-touch-action:none;" onload="oninitframework()">
	<script>
		function oninitframework()
		{
			...
			var screeninfo = [
            {"id":"screenMain","type":"desktop","themeid":"theme::default","xadl":"appMain.xadl.js"}
			];
			...
			// 초기 변수값  설정
			nexacro.setInitialVariable("environment", "gvRunMode", "<spring:eval expression="@systemProps['system.run.mode']"/>");
		}
